 ...
 * {@link TargetNotOwnedException#reason()}, never the URL value.
 */
@Component
public class TenantTargetValidator {
    ...
    /**
     * Validates all proposed target URLs against the AI target policy.
     *
     * @param targetUrls target URLs proposed by the LLM
     * @param tenantId   tenant identifier retained for the future tenant-specific ownership check
     * @throws TargetNotOwnedException if any target URL fails the validation gate
     */
